...
class SaaS_Home extends StatefulWidget {
  const SaaS_Home({super.key});

  @override
  State<SaaS_Home> createState() => _SaaS_HomeState();
}

class _SaaS_HomeState extends State<SaaS_Home> {
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        SaaS_Fetch(controller: _controller),
                                  ),
                                );
                              },
                              child: Card(
